...
create table users (
    ...
    org_level         smallint not null default 40,       -- 95=ผู้บริหาร, 85=GM, 75=ผจก.ฝ่าย, 65=ผจก.ส่วน, 55=ผจก.แผนก, 40=เจ้าหน้าที่ (ปรับตัวเลข/จำนวนระดับได้ตาม Org Chart จริง)
...
('900001', crypt('900001', gen_salt('bf')), 'สมชาย', 'ผู้บริหาร', 'พี่ชาย', 'ผู้จัดการทั่วไป', 'บริหาร', 85, null, 'ADMIN'),
('900002', crypt('900002', gen_salt('bf')), 'สมหญิง', 'ฝ่ายวิศวกรรม', 'พี่หญิง', 'ผู้จัดการฝ่าย', 'วิศวกรรม', 75, 1, 'SUPERVISOR'),
('900003', crypt('900003', gen_salt('bf')), 'วิชัย', 'ส่วนผลิต', 'พี่ชัย', 'ผู้จัดการส่วน', 'วิศวกรรม', 65, 2, 'SUPERVISOR'),
('443757', crypt('443757', gen_salt('bf')), 'มานะ', 'แผนกซ่อมบำรุง', 'มานะ', 'ผู้จัดการแผนก', 'วิศวกรรม', 55, 3, 'SUPERVISOR'),
('591144', crypt('591144', gen_salt('bf')), 'สายใจ', 'เจ้าหน้าที่', 'ใจ', 'เจ้าหน้าที่วิศวกรรม', 'วิศวกรรม', 40, 4, 'STAFF'),
('123456', crypt('123456', gen_salt('bf')), 'ทดสอบ', 'ระบบ', 'เทส', 'เจ้าหน้าที่ทั่วไป', 'ทั่วไป', 40, 4, 'STAFF');
